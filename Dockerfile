...
# Fonts/assets (Creditshare had mundial.ttf)
ADD mundial.ttf /usr/share/fonts/truetype

# Reports/assets (Creditshare)
ADD creditshare_faktura.rptdesign ${TOMCAT_HOME}/webapps/birt
ADD creditshare_komissmlouva.rptdesign ${TOMCAT_HOME}/webapps/birt
ADD creditshare_tax_report.rptdesign ${TOMCAT_HOME}/webapps/birt
ADD creditshare_vypis.rptdesign ${TOMCAT_HOME}/webapps/birt
ADD op2detail.rptdesign ${TOMCAT_HOME}/webapps/birt
